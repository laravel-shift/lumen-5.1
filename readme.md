# Lumen 5.1 for Laravel Shift

This repository contains the latest version of Lumen 5.1. It is used as a reference by [Laravel Shift - the automated way to upgrade Laravel applications](https://laravelshift.com).
